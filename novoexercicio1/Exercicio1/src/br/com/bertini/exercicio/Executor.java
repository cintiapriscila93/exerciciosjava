...
public class Executor {
	...
	public static void main(String[] args) {
     List <Cliente> listaCliente = new ArrayList<Cliente>();
		...
		cliente3.setProfissao("Estagiário");
		...
		List <Cliente> listaClienteProfissao = servico.buscarClientePorProfissao(listaCliente,"Professora");
		servico.imprimirListaCliente("Cliente com profissao exata", listaClienteProfissao);
		
		List <String> listaProfissao = new ArrayList<>();
		listaProfissao.add("Desenvolvedor");
		listaProfissao.add("Advogado");
       
		List <Cliente> listaClienteProfissao2 = servico.buscarClientePorProfissao(listaCliente, listaProfissao);
		servico.imprimirListaCliente("Cliente com profissoes fornecidas", listaClienteProfissao2);
	}
